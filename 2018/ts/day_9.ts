...
class List {
  ...
  constructor(start_val :number, last_val :number) {
    this.len = 2;
  ...
  appendmove(off :number, n :number) {
...
function high_score(player_n :number, last :number) :number {
